...
public class SimplePaintTraceBot2 implements OperadorUnarioDeImagen {
    int clicks;
    private final int initX;
    private final String name;
    private final int step;

    public SimplePaintTraceBot2(int initX, String name, int step) {
        super();
        this.initX = initX;
        this.name = name;
        this.step = step;
    ...
    private void traceDraw(Robot robot, int x, int y, Indexador indexador, int offsetX, int offsetY, int ancho, int alto) {
        ...
        Integer previousDirectionX = 1;
        Integer previousDirectionY = 1;
